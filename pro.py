...
def st_comment_table():
    ...
    for i in coll.find({},{"_id":0,"comment_information":1}):
        for j in range(len(i['comment_information'])):
                        cm_list.append(i['comment_information'][j])
...
if question=='1. What are the names of all the videos and their corresponding channels?':
        cursor.execute("select Video_Name as videoname, Channel_Name as channelname from video_table order by Channel_name")
